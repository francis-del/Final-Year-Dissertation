...
<div class="form-row">
	...
	Old password <font color="#E9F5DB">*</font>
	...
	<div class="col-md-6 form-group">
	New Password <font color="#E9F5DB">*</font>
	  <input type="password" name="newpassword" id="newpassword" class="form-control" >
	</div>	
	
	<div class="col-md-6 form-group">
		Confirm Password <font color="#E9F5DB">*</font>
...
<hr>
<button type="submit" name="submit" id="submit" class="btn btn-info btn-lg btn-block" >Change Your Password</button>
