...
(1, 'United Kingdom', 'The United Kingdom of Great Britain and Northern Ireland, is a sovereign country in the northwest of Europe, off the north-western coast of the European land, there are three main types of farming, pastoral, arable, and a mixture of the two...', 'Active'),
(3, 'USA', 'USA country', 'Active'),
(4, 'Nigeria', 'Nigeria is located in Africa.', '');
...
(11, 'francis', '7-8 king williams street', '1', '11', '112', '', '07869144440', 'admin@gmail.com', 'admin', '', 'Active');
...
(98, 0, 3, 11, 1, 1000.00, 'Active', 0),
(99, 0, 6, 11, 2, 300.00, 'Active', 0),
(101, 0, 2, 11, 1, 450.00, 'Pending', 0);
...
(1, 3, 1, 1, 1, '2022-03-02', '07:01:33', 3500.00, 300.00, 'Paid'),
(2, 4, 3, 1, 1, '2022-03-02', '07:11:29', 12000.00, 65.00, 'Paid'),
(3, 5, 4, 1, 2, '2022-03-02', '03:45:16', 1500.00, 200.00, 'Paid');
...
(12, 9, 'Visa', 'Card Holder Name: Adindu Maduekwe Card Number: 00000000000 Expiry date: 2023-04 CVV No.000', '2022-03-14', 350.00, 'Active');
...
(3, 1, 4, 450.00, '2022-03-02', '2022-03-09', 'Contact Soon', 'Active'),
(4, 1, 5, 200.00, '2022-03-02', '2022-03-09', 'Price Negotiable', 'Active'),
(5, 1, 4, 30.00, '2022-03-02', '2022-03-09', 'No Comments', 'Active'),
(6, 1, 4, 20.00, '2022-03-02', '2022-03-09', 'Test Round', 'Active'),
(7, 1, 3, 101.00, '2022-03-02', '2022-03-09', '', 'Active'),
(9, 1, 6, 130.00, '2022-03-03', '2022-03-10', 'test', 'Active'),
(10, 2, 6, 400.00, '2022-03-03', '2022-03-10', 'second test', 'Active'),
(12, 1, 5, 600.00, '2022-03-04', '2022-03-11', 'immediately needed', 'Active'),
...
(33, 11, 117, 15.00, '2022-04-22', '2022-04-29', 'like the item, how much', 'Pending'),
(34, 11, 6, 50.00, '2022-04-22', '2022-04-29', 'love the item, want to purchase them..', 'Pending');
...
INSERT INTO `seller` (`seller_id`, `seller_name`, `seller_address`, `state_id`, `country_id`, `city_id`, `postcode`, `contact_number`, `mobile_no`, `email_id`, `password`, `bank_name`, `bank_branch`, `bank_sortcode`, `bank_acno`, `status`) VALUES
(1, 'Adindu Maduekwe', 'Harper road, 1', 'Eng', 'Uk', 'Cov', 'cv12al', '07869144440', '0786914444', 'kingochina60@gmail.com', 'coventry2022', 'Monzo', 'london', 40004, '10904786', 'Active'),
(4, 'eric', '1 harper road', '12', '1', '11', '', '07869144440', '0786914444', 'eric@gmail.com', 'coventry2022', 'monzo', 'london', 0, '11111111111111111', 'Active');
...
(1, 8, 'Natural Fertlizer', 'Nitrogen, phosphorous, and potassium are essential to plant nutrients found in natural fertilisers. Natural fertiliser functions as a miraculous food in the soil, stimulating plant development. Plants slowly absorb nutrients for growth and reproduction.', '4901fertilizer1.jpg', '7418fertilizer2.jpg', '12971fertilizer3.png', '23816fertilizer4.jpg', '15521fertilizer5.jpg', 'Kilogram', 300.00, 'Active'),
(2, 23, 'Urea', 'Urea is low-cost nitrogen fertiliser. Synthetic urea is made from anhydrous ammonia, which is naturally produced in people and animals. Although urea provides gardeners with the greatest nitrogen for the least cost, it must be applied to the soil with care to avoid nitrogen loss due to a chemical reaction.', '6862urea.jpg', '24047urea2.jpeg', '252urea3.jpg', '25477urea4.jpg', '5594urea5.JPG', 'Kilogram', 450.00, 'Active'),
(3, 12, 'Hand Carts', 'A little vehicle with two wheels and two long handles that is pushed or dragged by your hands.', '13057cart2.jpg', '13734cart3.jpg', '7143cart5.jpg', '29588cart.jpg', '32317acrt4.jpg', 'Piece', 1000.00, 'Active'),
(4, 12, 'Composter', 'Insulated design for all climates\r\nComposts food waste safely and fast\r\nIt is rust proof and can be used outdoors.\r\nMultiple air vents help uniform composting.\r\nHeat-absorbing colour', '16697composter1.jpg', '21374composter2.jpg', '8415composter3.jpg', '8492composter4.jpg', '14325composter5.jpg', 'Piece', 1080.00, 'Active'),
...
(17, 1, 2, 'raddish', 'A reddish pink apple with a golden blush grown in Uttar Pradesh and Himachal Pradesh.', '7695mcintosh.png', 'Active'),
...
--
ALTER TABLE `product_purchase_record`
  MODIFY `purchase_record_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102;
