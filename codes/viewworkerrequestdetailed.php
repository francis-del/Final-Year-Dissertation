...
<table width="466" height="626" border="3" class="table table-bordered">
						    <tbody>
						      <tr>
						        <th width="178" scope="row"><strong> Farm Task</strong></th>
						        <td width="268">&nbsp;<?php echo $rs['task']; ?></td>
					          </tr>
                              <tr>
						        <th scope="row"><strong>Farm Worker Profile</strong></th>
						        <td>&nbsp;<?php echo $rsworker['work_profile']; ?></td>
					          </tr>
						      <tr>
						        <th height="113" scope="row"><strong>Farm Worker detail</strong> <br>						          <?php
						      ...
						      <tr>
						        <th scope="row"><strong>Farm Work Date</strong></th>
						        <td>&nbsp; <?php echo $rs['from_date']  ." to ". $rs['to_date']; ?></td>
					          </tr>
						      <tr>
						        <th scope="row"><strong>FaRm Work Location</strong></th>
						      ...
						      <tr>
						        <th scope="row" style="vertical-align: top;"><p><strong>Farm Worker Response</strong></p>
