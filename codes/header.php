...
<head>
  ...
  <title>FARMEX - Farm Management System For Commercial Farmers</title>
  <meta content="" name="To equip commercial farmers, merchants, and agricultural labourers with technology and services to help them expand their businesses and reach a wider market. Also, to improve current agricultural production and reduce current marketing challenges facing modern agriculture.">
  <meta content="Farm Management System, FARMEX" name="keywords">
    ...
    <div class="container">
      <div class="header-container d-flex align-items-center">
        <div class="logo mr-auto">
          <h1 class="text-light"><a href="index.php"><span>FARMEX</span></a></h1>
...
<li class="drop-down <?php
                            ...
                            ?>" ><a href="">My Account</a>
  <ul>
	<li><a href="sellerpanel.php">Farmer Page</a></li>
		
	<li class="drop-down"><a href="#">User Profile</a>
	  <ul>
			<li><a href="sellerprofile.php">Update Your Profile</a></li>
			<li><a href="Sellerchngpassword.php">Change Your Password</a></li>
	  </ul>
	</li>
	
	<li class="drop-down"><a href="#">Produce</a>
	  <ul>
			<li><a href="Product.php">Upload Your Produce</a></li>
			<li><a href="viewProduct.php">View and Update Your Produce</a></li>
	  </ul>
	</li>
	  ...
	  <ul>
			<li><a href="sellerpanelchart.php">Progress Chart</a></li>
         	...
         	<li><a href="viewpurchaseorder.php">View Purchase Order</a></li>
          	<li><a href="viewpurchasereport.php">Purchase Bill Report</a></li>
	  </ul>
	</li>
	
	<li class="drop-down"><a href="#">Farmer's workshop Report</a>
	  <ul>
			<li><a href="viewcstpurchasereport.php">Product Purchase Report</a></li>
	  </ul>
	</li>
	
	<li class="drop-down"><a href="#">Hire Info</a>
	  <ul>
...
<li class="drop-down <?php
  ...
  <ul>
	...
	<li><a href="workerprofile.php">User Profile</a></li>
	<li><a href="Workerchngpassword.php">Change Password</a></li>
	<li><a href="viewworkerrequest.php">View Your Farm opportunities</a></li>
...
<li class="drop-down <?php
                            ...
                            ?>" ><a href="">User Account</a>
  <ul>
	<li><a href="adminpanel.php">Admin Page</a></li>
	...
	<li class="drop-down"><a href="#">Report</a>
	  <ul>
		...
		<li><a href="viewadminpurchasereport.php">Farmer's Workshop -  Product Billing Report</a></li>
		<li><a href="viewSellingProduce.php">Market for Farmer's -  Produce Report</a></li>
		<li><a href="viewadminpurchaserequest.php">Market For Farmer's -  Produce Purchase Request</a></li>
		<li><a href="viewpurchasereport.php">Market For Farmer's -  Produce  Billing Report</a></li>
	  </ul>
	</li>
...
<li><a href="viewcountry.php">View Country</a></li> 
	...
	<li class="drop-down"><a href="#">Farmer Settings</a>
	  <ul>
<li><a href="category.php?cattype=Produce">Produce should be added to the list.</a></li>
...
<li><a href="variety.php?varietytype=Produce">Variety of produce should be included.</a></li>
<li><a href="viewvariety.php?varietytype=Produce">View Produce Variety</a></li> 
	  </ul>
	</li>
			
	<li class="drop-down"><a href="#">Farm Worker</a>
	  <ul>
<li><a href="viewworker.php">View Farm Worker</a></li>
<li><a href="viewworkerrequest.php">View Farm Worker Request</a></li>
	  </ul>
	</li>
	...
	<li class="drop-down"><a href="#">Farmer's Workshop</a>
	  <ul>
		...
		<li><a href="sellingproduct.php">Add  Farmer's Tool</a></li>
		<li><a href="viewsellingproduct.php">View  Farmer's Tool</a></li>
	  </ul>
	</li>
...
{
?>
<li class="drop-down"><a href="">User Account</a>
  <ul>
	<li><a href="customerreglogin.php">Customer</a></li>
	<li><a href="farmerreglogin.php">Farmer</a></li>
	<li><a href="workerreglogin.php">Worker</a></li>
  </ul>
</li>
<?php
}
