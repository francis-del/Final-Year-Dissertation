	  ...
	  <div class="col-lg-4">
		<div class="member" data-aos="zoom-in" data-aos-delay="100">
		  ...
		  <div class="member-info">
			...
			<span><strong>Expected Income </strong> <?php echo $rs['expected_salary']; ?>/day</span>
