...
if(isset($_POST['submit']))
{
	...
	{
$sql="INSERT INTO seller(seller_name, seller_address, state_id, country_id, city_id, postcode, contact_number, mobile_no, email_id, password, bank_name, bank_branch, bank_sortcode, bank_acno, status) VALUES ('$_POST[sellername]','$_POST[selleraddress]','$_POST[state]','$_POST[country]','$_POST[city]','$_POST[postcode]','$_POST[contactnumber]','$_POST[mbnumber]','$_POST[emailid]','$_POST[password]','$_POST[bankname]','$_POST[branch]','$_POST[sortcode]','$_POST[bankacnumber]','Active')";	
	if(!mysqli_query($con,$sql))
		{
...
<div class="form-row">
	...
	<div class="col-md-6 form-group">
	State <font color="#BBDEFB"> *</font>
	  <span id='loadstate'><?php include("ajaxstate.php"); ?></span>
	</div>
	
	<div class="col-md-6 form-group">
	City <font color="#BBDEFB"> *</font>
	...
	<div class="col-md-6 form-group">
	Bank Account Number  <font color="#BBDEFB">*</font>
...
?>
	...
	else if(document.frmsellreg.cpassword.value == "")
	{
		    ...
		    else if(!document.frmsellreg.branch.value.match(alphaspaceExp))
		{
		  ...
		  {
			alert("Kindly enter the SORT Code of the bank...");
			document.frmsellreg.sortcode.focus();
			return false;
		  }
		   else if(document.frmsellreg.sortcode.value.length > 11)
		  {
