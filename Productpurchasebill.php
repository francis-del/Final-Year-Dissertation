...
if(isset($_POST['submit']))
{
	...
	{
		$sql ="UPDATE product_purchase_bill SET `country_id`='$_POST[country]', `state_id`='$_POST[state]', `city_id`='$_POST[city]', `customer_name`='$_POST[customername]', `customer_address`='$_POST[customeraddress]', `postcode`='$_POST[postcode]', `customer_contact_number`='$_POST[contactnumber]', `purchase_date`='', `status`='$_POST[status]' WHERE product_purchase_bill_id='$_GET[editid]'";
	...
	{
$sql="INSERT INTO `product_purchase_bill`(`product_purchase_bill_id`, `country_id`, `state_id`, `city_id`, `customer_name`, `customer_address`, `postcode`, `customer_contact_number`, `purchase_date`, `status`) VALUES ('','$_POST[country]','$_POST[state]','$_POST[city]','$_POST[customername]','$_POST[customeraddress]','$_POST[postcode]','$_POST[contactnumber]','','$_POST[status]')";
if(!mysqli_query($con,$sql))
	{
		echo "Error in mysqli query";
	}
...
<div class="form-row">
	...
	<div class="col-md-6 form-group">
	Contact Number <font color="#EFE6DD">*</font>
