        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="section-title" data-aos="fade-right">
              ...
              <p>Do you want to buy from the Farmer?<br> <b>Login / Register as Worker</b></p>
            </div>
          </div>
          <div class="col-lg-8">
            <div class="row">
              ...
              <div class="col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
                <div class="icon-box" data-aos="zoom-in" data-aos-delay="200" style="width: 100%;">
				  ...
				  <button type="button" class="btn btn-warning btn-lg btn-block"  onclick="window.location='worker.php'" >Sign Up Now</button>
                </div>
              </div>
