...
if(isset($_POST['submit']))
{
	...
	$sql ="UPDATE worker SET name='$_POST[name]', address='$_POST[address]', state_id='$_POST[state]', city_id='$_POST[city]', country_id='$_POST[country]', postcode='$_POST[postcode]',contactno='$_POST[contct]', work_profile='$_POST[workprofile]', ";
