...
<div class="form-row">
	...
	Purchase Quantity<font color="#C5C3C6">*</font> <font color="#C5C3C6">  (in <?php echo $rs['quantity_type']; ?> ) </font>
	...
	<div class="col-md-6 form-group">
		Request Date<font color="#C5C3C6">*</font> <font color="#C5C3C6">  (in <?php echo $rs['quantity_type']; ?> ) </font>
		<input type="date" name="requestdate" id="requestdate" readonly value="<?php echo date("Y-m-d"); ?>" class="form-control">
	</div>
	
	<div class="col-md-6 form-group">
		Expiry Date<font color="#C5C3C6">*</font> <font color="#C5C3C6">  (in <?php echo $rs['quantity_type']; ?> ) </font>
