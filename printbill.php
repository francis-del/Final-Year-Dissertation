    ...
    <section id="contact" class="contact">
      <div class="container">
        <div class="row">
          ...
          <center><h1 class="text-light"><a href="index.php"><span>FARMEX</span></a></h1></center>
...
<hr>
<center><button onclick="myFunction()" autofocus class="btn btn-primary">Print</button></center>
                </div>
              </div>
            </form>
          </div>
