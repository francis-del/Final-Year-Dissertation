...
<div class="form-row">
	...
	Payment Type: <font color="#EFE6DD">*</font>
...
?>
 ...
 if(document.frmorderpayment.paymenttype.value == "")
	...
	{
		alert("Letters only for the Card Holder name..");
		document.frmorderpayment.txtcardholdname.focus();
		return false;
	}
